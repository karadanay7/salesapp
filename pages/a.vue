<template>
  ...
  <div
    class="bg-gray-100 min-h-screen flex flex-col items-center font-index p-8"
  >
    ...
    <UForm
      :schema="schema"
      :state="state"
      class="w-full max-w-3xl bg-white rounded-md p-4"
    >
      ...
      <div class="flex items-center justify-center pt-4">
        <UButton @click="uploadImage" color="primary">
          Apply & Get Password
        </UButton>
      </div>
    </UForm>
...
const schema = z
  ...
  .superRefine(({ confirmPassword, password }, withCtx) => {
